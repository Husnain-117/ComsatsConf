    ...
    >
      ...
      >
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <motion.div
            variants={cardVariants}
            className="lg:col-span-2 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden"
          >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="rounded-xl border-slate-300 focus:border-blue-500 h-12"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="rounded-xl border-slate-300 focus:border-blue-500 min-h-[120px] resize-none"
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
